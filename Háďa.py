...
def move_snake():
    ...
    canvas.delete('all')
    for x, y in snake: canvas.create_rectangle(x*20, y*20, x*20 + 20, y*20 + 20, fill='red')
    for x, y in trail: canvas.create_rectangle(x*20, y*20, x*20 + 20, y*20 + 20, fill='red')
